...
export class Ingresos extends Component {
    ...
    createClick() {
        ...
        axios.post(variables.API_URL + 'tiposingresos/PostAddTipoIngreso', {
            ...
            .then(() => {
                MySwal.fire({
                    title: <strong>Ingreso Insertado!</strong>,
                    icon: 'success'
                });
                this.refreshList();
            }, (error) => {
                                                            ...
                                                            <div className="modal-content">
                                                                ...
                                                                <div className="modal-body">
                                                                        ...
                                                                        <div className="d-flex flex-row bd-highlight mb-3">
                                                                            ...
                                                                            <div className="p-2 w-75 bd-highlight">
                                                                                ...
                                                                                <div className="mb-3">
                                                                                    ...
                                                                                    />
                                                                                    <div className="invalid-feedback">
                                                                                        Favor ingresar un nombre para el ingreso.
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div className="form-check">
                                                                                    <input
                                                                                        ...
                                                                                        checked={this.state.dependeSalarioI}
                                                                                    />
                                                                    ...
                                                                    {id !== "" ?
                                                                        ...
                                                                        >Actualizar Tipo Ingreso</button>
                                                                        : null}
                                                                </div>
